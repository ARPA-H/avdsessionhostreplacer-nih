...
$TemplateParameters = @{
    ...
    GalleryImageId = '/subscriptions/87a23dae-87b7-4372-b94f-92e72de0705e/resourceGroups/rg-avd-golden-image/providers/Microsoft.Compute/galleries/acgavd/images/GoldenImageAVDArpaH/versions/2.0.0' # Only required for 'CustomImage'. Use ResourceId of an Image Definition.
